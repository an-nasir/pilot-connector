...
class PaymentRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_request" do
    assert_difference('PaymentRequest.count') do
      post payment_requests_url, params: { payment_request: { amount: @payment_request.amount, currency: @payment_request.currency, description: @payment_request.description, status: @payment_request.status } }
    end
  ...
  test "should update payment_request" do
    patch payment_request_url(@payment_request), params: { payment_request: { amount: @payment_request.amount, currency: @payment_request.currency, description: @payment_request.description, status: @payment_request.status } }
